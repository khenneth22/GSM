...
<head>
    ...
    <title>Inventory - Administrator</title>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-sm-1">Inventory </div>
                                        <div class="col-sm-4">
                                            <select onchange="switchCard();" id="opt_category" class="form-control">
                                                <option selected="" value="Inventory Summary">Inventory Summary</option>
                                ...
                                <div class="card-body" id="log" style="display:none;">
                                    <div class="row" style="margin-bottom: 20px;">
                                        <div class="col-sm-3">
                                            <span>Date | from:</span>
                                            <input id="date_from_log" class="form-control" type="date" name="">
                                        </div>
                                        <div class="col-sm-3">
                                            <span>to:</span>
                                            <input id="date_to_log" class="form-control" type="date" name="">
                                        </div>

                                        <div class="col-sm-3">
                                            <span>Stall:</span>
                                            <select class="form-control" id="stall_search_log">
                                                <optgroup id="opt_searchStall_log"></optgroup>
                                            </select>
                                        </div>
                                        <div class="col-sm-1">
                                            <span></span>
                                            <a id="btn_generate_log" class="btn btn-dark btn-circle"
                                                style="color:white;cursor: pointer;float: right;margin-top: 20px;"
                                                onclick="fetchRecordLog();"><i class="fa fa-search"></i></a>
                                        </div>
                                        <div class="col-sm-1">
                                            <span></span>
                                            <a onclick="printReportLog();" id="btn_print_log"
                                                class="btn btn-dark btn-circle"
                                                style="color:white;cursor: pointer;margin-top: 20px;"><i
                                                    class=" fa fa-print"></i></a>
                                        </div>
                                    </div>
                                    <table class="table table-hover" id="tbl_log">
                                        <thead class="table-header">
                                            <tr>
                                                <th class="text-center">
                                                    Date
...
function fetchStallIDforSearch() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            document.getElementById("opt_searchStall_log").innerHTML = data;
        }
    });
}
...
function printReport() {
    ...
    window.open("print_summary.php?" + other_data, '_blank',
...
function fetchRecord() {
    ...
    var dataTable1 = $('#tbl_health').DataTable({
        ...
        "ajax": {
            url: "functions/select_inventory_summary.php?" + other_data,
            type: "POST",
            cache: false,
...
function fetchRecordLog() {

    var date_from = document.getElementById('date_from_log').value;
    var date_to = document.getElementById('date_to_log').value;
    var stall = document.getElementById('stall_search_log').value;
    ...
    var dataTable1 = $('#tbl_log').DataTable({
        ...
        "ajax": {
            url: "functions/select_inventory_log.php?" + other_data,
            type: "POST",
            cache: false,
...
function printReportLog() {
    ...
    fetchRecordLog();
    var other_data = 'date_from=' + date_from + '&date_to=' + date_to + '&stall=' + stall;
    window.open("print_log.php?" + other_data, '_blank',
        'location=yes,height=1366,width=768,scrollbars=yes,status=yes');
}
</script>