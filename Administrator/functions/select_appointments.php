...
session_start();
$query = "SELECT `_id`, `_transaction_num`, `_date`, `_time`, `_customer_email`, `_customer_name`, `_customer_contact`, `_customer_address`, `_origin`, `_stall_id`, `_status`,`_emp_name` FROM `tbl_appointment` WHERE `_status` LIKE 'approved' AND `_origin` LIKE 'appointment'";
...
require ("../../db_connection/myConn.php");
 $query = "SELECT `_id`, `_transaction_num`, `_date`, `_time`, `_customer_email`, `_customer_name`, `_customer_contact`, `_customer_address`, `_origin`, `_stall_id`, `_status` FROM `tbl_appointment` WHERE `_status` LIKE 'approved' AND `_origin` LIKE 'appointment'";
