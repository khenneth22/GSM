...
<head>
    ...
    <title>Device List - Administrator</title>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    Device List <a data-toggle="modal" data-target="#stallModal" style="color:white;"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <span>Unit</span>
                    <input class="form-control" type="text" id="_unit" style="margin-bottom: 20px;"
                        placeholder="Device unit">
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
...
function fetchRecord() {
    ...
    var dataTable1 = $('#tbl_health').DataTable({
        ...
        "ajax": {
            url: "functions/select_device_list.php?",
            type: "POST",
            cache: false,
...
function addRecord() {
    ...
    var _unit = document.getElementById("_unit").value.trim();

    if (_unit == '') {
        var element = document.getElementById("_unit");
    ...
    swal({
        title: "Continue?",
        text: "Do you want to add this new device?",
        type: "question",
        ...
        if (result.value) {
            $.ajax({
                ...
                url: "functions/add_device.php?" + other_data,
                type: "POST",
                contentType: false,
                cache: false,
                processData: false,
                ...
                success: function(data) {
                    ...
                    if (data.includes('200')) {
                        ...
                        swal({
                            title: "Success!",
                            text: "New device has been successfully added!",
                            type: "success"
                        }).then(okay => {
                            if (okay) {
    ...
    swal({
        ...
        if (result.value) {
            $.ajax({
                ...
                url: "functions/update_device.php?" + other_data,
                type: "POST",
                contentType: false,
                cache: false,
                processData: false,
...
$(document).on("click", "#btn_edit", function() {
    ...
    document.getElementById("_unit").value = $(this).data('_unit');
    commandStr = 'update';
});
    ...
    swal({
        ...
        if (result.value) {
            $.ajax({
                ...
                url: "functions/delete_device.php?" + other_data,
                type: "POST",
                contentType: false,
                cache: false,
                processData: false,
