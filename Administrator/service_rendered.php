...
<head>
    ...
    <title>Servce Rendered - Administrator</title>
...
function printReport() {
    ...
    var other_data = 'date_from=' + date_from + '&date_to=' + date_to + '&stall=' + stall + '&type=' + _type;
    fetchRecord();
    window.open("print_sales.php?" + other_data, '_blank',
...
function fetchRecord() {
    ...
    var dataTable1 = $('#tbl_health').DataTable({
        ...
        "ajax": {
            url: "functions/select_sales.php?" + other_data,
            type: "POST",
            cache: false,
