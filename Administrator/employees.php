...
<head>
    ...
    <title>Employees - Administrator</title>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    List of your Employees <a data-toggle="modal" data-target="#employeeModal"
                ...
                <div class="modal-body">
                    <div class="col-md-12 pr-1">
                        <div class="form-group">
                            <center> <img class="" id="image_add" src="img/avatar.png"
                    ...
                    <input class="form-control" type="email" id="email" style="margin-bottom: 20px;"
                        placeholder="Your employee's email...">
                    <span>First name</span>
                    <input class="form-control" type="text" id="firstname" style="margin-bottom: 20px;"
                        placeholder="First name...">
                    <span>Middle name</span>
                    <input class="form-control" type="text" id="middlename" style="margin-bottom: 20px;"
                        placeholder="Middle name...">
                    <span>Last name</span>
                    <input class="form-control" type="text" id="lastname" style="margin-bottom: 20px;"
                        placeholder="Last name...">
                    <span>Contact #</span>
                    <input class="form-control" type="number" maxlength="11" id="contact" style="margin-bottom: 20px;"
                        placeholder="Contact number...">
                    <span>Address</span>
                    <input class="form-control" type="text" id="address" style="margin-bottom: 20px;"
                        placeholder="Address...">
                    <span>Stall</span>
...
function fetchRecord() {
    ...
    var dataTable1 = $('#tbl_health').DataTable({
        ...
        "ajax": {
            url: "functions/select_employees_table.php?",
            type: "POST",
            cache: false,
...
function addRecord() {
    ...
    if (stall_id == '' || email == '' || firstname == '' || lastname == '' || contact == '' || address == '') {
        swal({
            title: "Warning!",
    ...
    swal({
        title: "Continue?",
        text: "Do you want to add this new employee?",
        type: "question",
        ...
        if (result.value) {
            $.ajax({
                ...
                url: "functions/add_employee.php?" + other_data,
                type: "POST",
                data: fd,
                contentType: false,
                cache: false,
    ...
    swal({
        ...
        if (result.value) {
            $.ajax({
                ...
                url: "functions/update_employee.php?" + other_data,
                type: "POST",
                data: fd,
                contentType: false,
                cache: false,
...
$(document).on("click", "#btn_edit", function() {
    ...
    document.getElementById("image_add").src = "img/employees/" + $(this).data('img');
    commandStr = 'update';
...
$(document).on("click", "#btn_delete", function() {
    ...
    swal({
        title: "Continue?",
        text: "Do you want to delete this employee's information?",
        type: "question",
        showCancelButton: true,
        confirmButtonColor: "#5cb85c",
        cancelButtonColor: "#d9534f",
        ...
        if (result.value) {
            $.ajax({
                ...
                url: "functions/delete_employee.php?" + other_data,
                type: "POST",
                contentType: false,
                cache: false,
                processData: false,
                ...
                success: function(data) {
                    ...
                    if (data.includes('200')) {
                        ...
                        swal({
                            title: "Success!",
                            text: "Employee's information has been successfully deleted!",
                            type: "success"
                        }).then(okay => {
                            if (okay) {
