      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="table-responsive" id="tbl">
          	...
          	<center><h5>Replenishment Report</h5></center>
          	<?php
        ...
        $total=0;
				if($result->num_rows > 0) {
					...
					$output.= '<tr>';	 
						...
						$output.='<td id="td_name'.$row["_id"].'"><center>'.$row["_quantity"].'</center></td>';
						$output.= '<td id="td_name'.$row["_id"].'"><center>'.number_format($row["_price"],2).'</center></td>';
							$output.= '</tr>';
            ...
            <span class="text-end" style="margin-top: 20px;font-style: italic;" ><strong>Total Qty: <?php echo $total; ?></strong></span><br>                                          
