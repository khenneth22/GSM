...
<head>
  ...
  <title>Appointment Requests - GSM Pioneer</title>
...
<script type="text/javascript">
  ...
  function fetchRecord(){
   ...
   var dataTable1 = $('#tbl_health').DataTable({
    ...
    "ajax" : {
     url:"functions/select_requests.php?",
     type:"POST",
     cache:false,
...
function fetchConcerns(transaction_num){
  ...
  $(document).on("click", "#btn_view", function() {
    ...
    if (reason=='') {
       swal({title:"Warning!",text: "Please input a reason!", type:"error"}); 
       return;
    }
    ...
    swal({
     ...
     $.ajax({
                  ...
                  url:"functions/decline_appointment.php?"+other_data, 
                  type:"POST", 
                  contentType:false,
                  cache:false,
                  processData:false,
                  ...
                  if (data.includes('200')) { 
                      ...
                      fetchRecord();
                      swal({title:"Success!",text: "Appointment has been declined successfully!", type:"success"}).then(okay => {
                              if (okay) {
    ...
    swal({
     ...
     $.ajax({
                  ...
                  url:"functions/approve_appointment.php?"+other_data, 
                  type:"POST", 
                  contentType:false,
                  cache:false,
                  processData:false,
                  ...
                  if (data.includes('200')) { 
                      fetchRecord();
                      swal({title:"Success!",text: "Appointment has been approved successfully!", type:"success"}).then(okay => {
                              if (okay) {
