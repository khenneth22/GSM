...
<head>
  ...
  <title>Walk-in Appointments - GSM Pioneer</title>
...
<body id="page-top">
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                Walk-in appointments <a data-toggle="modal" data-target="#requestModal" style="color:white;" class="btn btn-dark" onclick="clearFields();" ><strong>+</strong></a>
              </div>
                <div class="card-body">
  ...
  <div class="modal fade" id="requestModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Create walk-in appointment</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <div class="modal-body">
          <span>Name</span>
         <input class="form-control"  type="text" id="customer_name" style="margin-bottom: 20px;">

          <span>Contact</span>
         <input class="form-control"  type="text" id="customer_contact" style="margin-bottom: 20px;">

          <span>Address</span>
         <input class="form-control"  type="text" id="customer_address" style="margin-bottom: 20px;">
        ...
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
          <a class="btn btn-primary" style="color:white;" id="btn_submit">Create</a>
        </div>
      </div>
    </div>
  </div>
...
function fetchServiceDetails(){
  ...
  function fetchRecord(){
   ...
   var dataTable1 = $('#tbl_health').DataTable({
    ...
    "ajax" : {
     url:"functions/select_walkin_appointment.php?",
     type:"POST",
     cache:false,
...
function fetchConcerns(transaction_num){
  ...
  function addRecord(){
   ...
   $(document).on("click", "#btn_submit", function() {
    ...
    var customer_contact = document.getElementById("customer_contact").value.trim();
    var customer_address = document.getElementById("customer_address").value.trim();
    if (customer_name=='') {
     var element = document.getElementById("customer_name");
     element.classList.add("required-fields");
    }else{
      var element = document.getElementById("customer_name");
      element.classList.remove("required-fields");
     ...
     if (customer_contact=='') {
     var element = document.getElementById("customer_contact");
     element.classList.add("required-fields");
    }else{
      var element = document.getElementById("customer_contact");
      element.classList.remove("required-fields");
     ...
     if (customer_address=='') {
     var element = document.getElementById("customer_address");
     element.classList.add("required-fields");
    }else{
      var element = document.getElementById("customer_address");
      element.classList.remove("required-fields");
    ...
    if (customer_contact=='' || customer_name == '' || customer_address=='') {
       swal({title:"Warning!",text: "Please complete the required fields!", type:"error"}); 
       return;
    }
    var other_data = 'customer_name='+customer_name+
    ...
    swal({
                    title: "Continue?",
                    text: "Do you want to create this walk-in appointment?",
                    type: "question",
                    showCancelButton: true,
                    confirmButtonColor: "#5cb85c",
                    cancelButtonColor: "#d9534f",
     ...
     $.ajax({
                  ...
                  url:"functions/book_walkin_appointment.php?"+other_data, 
                  type:"POST", 
                  contentType:false,
                  cache:false,
                  processData:false,
                  ...
                  if (data.includes('200')) { 
                      ...
                      swal({title:"Success!",text: "Appointment has been successfully created!", type:"success"}).then(okay => {
                              if (okay) {
