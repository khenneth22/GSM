...
$(document).on("click", "#btn_complete", function() {
    ...
    swal({
     ...
     $.ajax({
                  ...
                  url:"functions/mark_completed.php?"+other_data, 
                  type:"POST", 
                  contentType:false,
                  cache:false,
                  processData:false,
                  ...
                  if (data.includes('200')) { 
                      ...
                      fetchRecord();
                      swal({title:"Success!",text: "Appointment has been completed successfully!", type:"success"}).then(okay => {
                              if (okay) {
