                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        <center>  <img class="" id="image_add" src="../Administrator/img/employees/<?php echo $photo; ?>" style="height: 230px; width: 230px;border-radius: 50%;box-shadow: 20px 20px 50px lightgrey;margin-bottom: 20px;" >
                    ...
                    <input class="form-control" type="email" id="email" style="margin-bottom: 20px;" placeholder="Email..." disabled="" value="<?php echo $email; ?>" disabled="">
                    <span>First name</span>
                    <input class="form-control" type="text" id="firstname" style="margin-bottom: 20px;" placeholder="First name..." value="<?php echo $firstname; ?>" disabled="">
                    <span>Middle name</span>
                    <input class="form-control" type="text" id="middlename" style="margin-bottom: 20px;" placeholder="Middle name..." value="<?php echo $middlename; ?>" disabled="">
                    <span>Last name</span>
                    <input class="form-control" type="text" id="lastname" style="margin-bottom: 20px;" placeholder="Last name..." value="<?php echo $surname; ?>" disabled="">
                    <span>Contact #</span>
                    <input class="form-control" type="number" maxlength="11" id="contact" style="margin-bottom: 20px;" placeholder="Contact number..." value="<?php echo $contact; ?>" disabled="">
                    <span>Address</span>
                    <input class="form-control" type="text" id="address" style="margin-bottom: 20px;" placeholder="Address..." value="<?php echo $address; ?>" disabled="">
