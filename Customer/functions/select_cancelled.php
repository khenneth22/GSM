...
$query = "SELECT `_id`, `_transaction_num`, `_date`, `_time`, `_customer_email`, `_customer_name`, `_customer_contact`, `_customer_address`, `_origin`, `_stall_id`, `_status`,`_cancel_reason` FROM `tbl_appointment` WHERE `_customer_email` LIKE '$email' AND `_status` LIKE 'cancelled'";
...
require ("../../db_connection/myConn.php");
$email=$_SESSION["_email"];
 $query = "SELECT `_id`, `_transaction_num`, `_date`, `_time`, `_customer_email`, `_customer_name`, `_customer_contact`, `_customer_address`, `_origin`, `_stall_id`, `_status` FROM `tbl_appointment` WHERE `_customer_email` LIKE '$email' AND `_status` LIKE 'cancelled'";
