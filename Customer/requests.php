    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          <h3>YOUR APPOINTMENT REQUEST(S)</h3>
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                Requests <a data-toggle="modal" data-target="#requestModal" style="color:white;" class="btn btn-dark" onclick="clearFields();" ><strong>+</strong></a>
              </div>
                <div class="card-body">
     ...
     $.ajax({
                  ...
                  if (data.includes('200')) { 
                    fetchRecord();
                     ...
                     swal({title:"Warning!",text: "You already have an appointment at "+ stall_id+" on "+_date + ". Please choose another date.", type:"error"}); 
